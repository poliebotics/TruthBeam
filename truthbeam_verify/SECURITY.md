...
**What to include.** The artifact URL or commit hash, the exact steps to reproduce, and — for a forgery
...
- *In scope:* the published verifier/forger code, the chain and anchor (drand / Rootstock) verification,
  the released artifacts, and any credential or third-party-privacy leak in this repository.
